# download ollama
# ollama pull gemma3:1b-it-qat for lightweight model for tasks like summarization and extraction
# ollama pull gemma3:4b-it-qat for more advanced tasks like generating text
# ollama pull gemma3:27b-it-qat for creative work like generating text
...
def extract_website_core_content(html: str) -> str:
...
def generate_x_post(summary: str) -> str:
    with open("06-post-examples.json", "r") as f:
...
def main():
    ...
    core_content = extract_website_core_content(html_content)
