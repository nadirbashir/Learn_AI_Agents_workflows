...
# This script fetches a website's HTML, extracts the core content, summarizes it, and generates an X post based on the summary.
import json
...
def summarize_content(content: str) -> str:
    response = client.responses.create(
        ...
        input=f"""
            ...
            provide a brief summary of the main points in the content. Prefer bullet points and avoid unncessary explanations.
        """
    )
